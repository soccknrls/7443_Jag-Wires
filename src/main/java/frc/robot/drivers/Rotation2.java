...
public final class Rotation2 implements Interpolable<Rotation2>, Serializable {
    ...
    public Rotation2(double x, double y, boolean normalize) {
        ...
        if (Vector2.epsilonEquals(cos, 0.0)) {
            if (sin >= 0) {
    ...
    public boolean isParallel(Rotation2 other) {
        return Vector2.epsilonEquals(Vector2.fromAngle(this).cross(Vector2.fromAngle(other)), 0.0);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Vector2.epsilonEquals(cos, other.cos) && Vector2.epsilonEquals(sin, other.sin);
    }

    public boolean equals(Rotation2 other, double maxError) {
        return Vector2.epsilonEquals(cos, other.cos, Math.abs(Math.cos(maxError))) &&
               Vector2.epsilonEquals(sin, other.sin, Math.abs(Math.sin(maxError)));
    }
