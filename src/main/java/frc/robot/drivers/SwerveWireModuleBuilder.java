...
public class SwerveWireModuleBuilder {
    /**
    ...
    public SwerveWireModuleBuilder(Vector2 modulePosition) {
     ...
     * @return The builder.
     */
    public SwerveWireModuleBuilder angleEncoder(AnalogInput encoder, double offset) {
        angleSupplier = () -> {
     ...
     * @return The builder.
     */
    public SwerveWireModuleBuilder angleMotor(CANSparkMax motor) {
        return angleMotor(motor, DEFAULT_CAN_SPARK_MAX_ANGLE_CONSTANTS, DEFAULT_ANGLE_REDUCTION);
    }

    public SwerveWireModuleBuilder angleMotor(CANSparkMax motor, MotorType motorType) {
     ...
     * @return The builder.
     */
    public SwerveWireModuleBuilder angleMotor(CANSparkMax motor, PidConstants constants, double reduction) {
     ...
     * @return The builder.
     */
    public SwerveWireModuleBuilder angleMotor(SpeedController motor) {
        return angleMotor(motor, MotorType.NEO);
    }

    public SwerveWireModuleBuilder angleMotor(SpeedController motor, MotorType motorType) {
        switch (motorType) {
            case CIM:
     ...
     * @return The builder.
     */
    public SwerveWireModuleBuilder angleMotor(SpeedController motor, PidConstants constants) {
     ...
     * @return The builder.
     */
    public SwerveWireModuleBuilder driveMotor(CANSparkMax motor) {
        return driveMotor(motor, MotorType.NEO);
    }

    public SwerveWireModuleBuilder driveMotor(CANSparkMax motor, MotorType motorType) {
        if (motorType == MotorType.NEO) {
     ...
     * @return The builder.
     */
    public SwerveWireModuleBuilder driveMotor(CANSparkMax motor, double reduction, double wheelDiameter) {
        CANEncoder encoder = motor.getEncoder();
     ...
     * @return The builder.
     */
    public SwerveWireModuleBuilder driveMotor(SpeedController motor, MotorType motorType) {
        // Spark MAXs are special and drive brushed motors in the opposite direction of every other motor controller
    ...
    public SwerveModule build() {
        ...
        if (angleSupplier == null) {
            ...
            throw new IllegalStateException("No absolute encoder has been configured! See SwerveWireModuleBuilder.angleEncoder");
        } else if (driveOutputConsumer == null) {
            // Drive motor not configured
            throw new IllegalStateException("No drive motor has been configured! See SwerveWireModuleBuilder.driveMotor");
        } else if (targetAngleConsumer == null) {
            // Angle motor not configured
            throw new IllegalStateException("No angle motor has been configured! See SwerveWireModuleBuilder.angleMotor");
        }
